...
function PelucheGanchoGame:new(nameP)
  self.name = nameP
  if self.name == "marina" then self.image = GANCHO_PELUCHE_MARINA end
  if self.name == "takeo" then self.image = GANCHO_PELUCHE_TAKEO end
  if self.name == "ricky" then self.image = GANCHO_PELUCHE_RICKY end
  if self.name == "alex" then self.image = GANCHO_PELUCHE_ALEX end
