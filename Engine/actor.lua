...
function Actor:new(image,x,y,fx,fy,speed,layer, ap)
    ...
    if ap then self.origin = Vector.new(self.image:getWidth()/2 ,0)
    else self.origin = Vector.new(self.image:getWidth()/2 ,self.image:getHeight()/2) end
